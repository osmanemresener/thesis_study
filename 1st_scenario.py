from predicting_functions import polynomial_regression_prediction, linear_regression_prediction, random_forest_regression,train_test_splits, sc_1_neural_network
...
##############################################################################################
"""This scenario aims to estimate removed sensor nodes data from one of closest sensor node"""
##############################################################################################
...
train_x, train_y, test_x, test_y, train_time, test_time = train_test_splits(get_closest_sensors_data_as_features(all=False),labels_df,shuffle=False)
...
print(train_time.max(),test_time.min())
...
sc_1_neural_network(train_x,train_y,test_x,test_y)
prediction_to_plot(sc_1_neural_network, removed_sensor_node, train_x, train_y, test_x, test_y, train_time, test_time)
